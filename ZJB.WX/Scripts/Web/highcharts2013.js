...
(function() {
    ...
    function Ob(a, b, c, d) {
        ...
        if (b >= D[Ja]) i[Bb](b >= D[pa] ? 0 : j * V(i[kb]() / j));
        ...
        d = 1;
        h = i[Xa]();
        for (var k = i.getTime(), l = i[Wa](), m = i[La](), i = g ? 0 : (864E5 + i.getTimezoneOffset() * 6E4) % 864E5; k < c;) e.push(k),
        b === D[ta] ? k = Ya(h + d * j, 0) : b === D[Ka] ? k = Ya(h, l + d * j) : !g && (b === D[pa] || b === D[Va]) ? k = Ya(h, l, m + d * j * (b === D[pa] ? 1 : 7)) : (k += b * j, b <= D[Ja] && k % D[pa] === i && (f[k] = pa)),
        d++;
        e.push(k);
        e.info = s(a, {
            higherRanks: f,
    ...
    Ra,
    ga = z.documentElement.ontouchstart !== x,
    Jb = {},
    ub = 0,
    Za,
    O,
    ...
    var qa = function(a) {
        var b = [],
        c; (function(a) { (c = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/.exec(a)) ? b = [A(c[1]), A(c[2]), A(c[3]), parseFloat(c[4], 10)] : (c = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/.exec(a)) && (b = [A(c[1], 16), A(c[2], 16), A(c[3], 16), 1])
        })(a);
        return {
            get: function(c) {
    ...
    va.prototype = {
        ...
        attr: function(a, b) {
            ...
            r = B(g, c) || this[c] || 0,
            c !== "d" && c !== "visibility" && (r = parseFloat(r));
        ...
        htmlUpdateTransform: function() {
            if (this.added) {
                ...
                if (b.tagName === "SPAN") {
                    ...
                    k = {};
                    if (M !== this.cTT) {
                        if (u(j)) a.isSVG ? (q = Ha ? "-ms": tb ? "-webkit": bb ? "-moz": Ib ? "-o": "", k[q + "-transform"] = k.transform = "rotate(" + j + "deg)") : (o = j * ab, r = W(o), o = aa(o), k.filter = j ? ["progid:DXImageTransform.Microsoft.Matrix(M11=", r, ", M12=", -o, ", M21=", o, ", M22=", r, ", sizingMethod='auto expand')"].join("") : T),
                        G(b, k);
        ...
        getBBox: function() {
            ...
            if (!a) {
                ...
                if (b.isSVG && (b = a.width, c = a.height, d)) a.width = N(c * aa(e)) + N(b * W(e)),
        ...
        shadow: function(a, b, c) {
            ...
            if (a) {
                ...
                for (e = 1; e <= i; e++) {
                    ...
                    if (c) B(f, "height", v(B(f, "height") - h, 0)),
                    f.cutHeight = h;
    ...
    ra.prototype = {
        ...
        buildText: function(a) {
            for (var b = a.element,
            c = p(a.textStr, "").toString().replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g), d = b.childNodes, e = /style="([^"]+)"/, f = /href="([^"]+)"/, g = B(b, "x"), h = a.styles, i = h && A(h.width), j = h && h.lineHeight, k, h = d.length, l = []; h--;) b.removeChild(d[h]);
            ...
            function(c, d) {
                ...
                function(c) {
                    if (c !== "" || h.length === 1) {
                        ...
                        ea ? m.dx = 3 : m.x = g;
                        if (!ea) {
                            if (d) { ! fa && a.renderer.forExport && G(p, {
                                    display: "block"
                                });
                        ...
                        b.appendChild(p);
                        ea++;
                        if (i) for (var c = c.replace(/-/g, "- ").split(" "), I = []; c.length || I.length;) delete a.bBox,
                        n = a.getBBox().width,
                        m = n > i,
                        !m || c.length === 1 ? (c = I, I = [], c.length && (p = z.createElementNS("http://www.w3.org/2000/svg", "tspan"), B(p, {
                            dy: j || 16,
                            x: g
                        }), b.appendChild(p), n > i && (i = n))) : (p.removeChild(p.firstChild), I.unshift(c.pop())),
        ...
        button: function(a, b, c, d, e, f, g) {
            ...
            o = g.style;
            delete g.style;
            H(h.element, "mouseenter",
            function() {
                h.attr(f).css(m)
            });
            H(h.element, "mouseleave",
            function() {
                j = [e, f, g][i];
                k = [l, m, o][i];
                h.attr(j).css(k)
        ...
        label: function(a, b, c, d, e, f, g, h, i) {
            function j() {
                ...
                if (u(Da) && (a === "center" || a === "right")) b += {
                    center: 0.5,
                    right: 1
                } [a] * (Da - q.width); (b !== r.x || c !== r.y) && r.attr({
                    x: b,
                    y: c
                });
                r.x = b;
    ...
    if (!fa && !$) {
        ka = {
            init: function(a, b) {
                ...
                d = ["position: ", "absolute", ";"]; (b === "shape" || b === ia) && d.push("left:0;top:0;width:1px;height:1px;");
                Qa && d.push("visibility: ", b === ia ? "hidden": "visible");
                c.push(' style="', d.join(""), '"/>');
                if (b) c = b === ia || b === "span" || b === "img" ? c.join("") : a.prepVML(c),
                this.element = S(c);
                this.renderer = a;
                this.attrSetters = {}
            },
            ...
            attr: function(a, b) {
                ...
                a[c] = b);
                if (ma(a)) c = a,
                r = c === "strokeWidth" || c === "stroke-width" ? this.strokeweight: this[c];
                    ...
                    m = !0;
                    else if (c === "width" || c === "height") d = v(0, d),
                    this[c] = d,
        ...
        var ha = {
            ...
            color: function(a, b, c, d) {
                ...
                if (i) {
                    ...
                    o = m.x2 || m[2] || 0,
                    m = m.y2 || m[3] || 0,
                    M = 'angle="' + (90 - K.atan((m - a) / (o - c)) * 180 / xa) + '"',
                    I();
                    else {
                        var j = m.r,
                        J = j * 2,
            ...
            symbols: {
                ...
                rect: function(a, b, c, d, e) {
                    var f = a + c,
                    g = b + d,
                    h; ! u(e) || !e.r ? f = ra.prototype.symbols.square.apply(0, arguments) : (h = P(e.r, c, d), f = ["M", a + h, b, "L", f - h, b, "wa", f - 2 * h, b, f, b + 2 * h, f - h, b, f, b + h, "L", f, g - h, "wa", f - 2 * h, g - 2 * h, f, g, f, g - h, f - h, g, "L", a + h, g, "wa", a, g - 2 * h, a + 2 * h, g, a + h, g, a, g - h, "L", a, b + h, "wa", a, b, a + 2 * h, b + 2 * h, a, b + h, a + h, b, "x", "e"]);
                    return f
                }
            }
        };
    ...
    Pa.prototype = {
        ...
        render: function(a, b) {
            ...
            if (h && !isNaN(Q)) h.xy = J = this.getLabelPosition(Q, J, h, f, j, I, a, t),
            this.isFirst && !p(d.showFirstLabel, 1) || this.isLast && !p(d.showLastLabel, 1) ? w = !1 : !v && f && j.overflow === "justify" && !this.handleOverflow(a, J) && (w = !1),
            t && a % t && (w = !1),
    ...
    ob.prototype = {
        ...
        getSeriesExtremes: function() {
            ...
            function(g) {
                if (g.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isXAxis) {
                        if (h = g.xData, h.length) a.dataMin = P(p(a.dataMin, h[0]), Ma(h)),
                        ...
                        r = g.processedYData;
                        t = r.length;
                        for (f = 0; f < t; f++) if (n = h[f], q = r[f], q !== null && q !== x && (i ? (J = (I = q < y) ? k: j, Q = I ? o: l, q = J[n] = u(J[n]) ? J[n] + q: q, c[Q] || (c[Q] = {}), c[Q][n] || (c[Q][n] = new Hb(a, a.options.stackLabels, I, n, m)), c[Q][n].setTotal(q)) : A && (q = g.modifyValue(q)), C || (h[f + 1] || n) >= Ea.min && (h[f - 1] || n) <= Ea.max)) if (n = q.length) for (; n--;) q[n] !== null && (s[w++] = q[n]);
                        else s[w++] = q;
                        if (!a.usePercentage && s.length) a.dataMin = P(p(a.dataMin, s[0]), Ma(s)),
        ...
        getLogTickPositions: function(a, b, c, d) {
            ...
            g = this.getLinearTickPositions(a, b, c);
                ...
                i = e.length;
                for (h = 0; h < i && !l; h++) j = na(ca(f) * e[h]),
                j > b && g.push(k),
                k > c && (l = !0),
                k = j
            } else if (b = ca(b), c = ca(c), a = e[d ? "minorTickInterval": "tickInterval"], a = p(a === "auto" ? null: a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length: f) || 1)), a = hb(a, null, K.pow(10, V(K.log(a) / K.LN10))), g = Sa(this.getLinearTickPositions(a, b, c), na), !d) this._minorAutoInterval = a / 5;
        ...
        setAxisTranslation: function() {
            ...
            function(a) {
                ...
                b = v(b, f);
                d = v(d, i ? 0 : f / 2);
                e = v(e, i === "on" ? 0 : f); ! a.noSharedTooltip && u(j) && (c = u(c) ? P(c, j) : j)
            }),
        ...
        setTickPositions: function(a) {
            ...
            if (e) ! a && P(b.min, p(b.dataMin, b.min)) <= 0 && $a(10, 1),
            b.min = ja(na(b.min)),
            b.max = ja(na(b.max));
            ...
            if (!i) i = f ? (b.getNonLinearTimeTicks || Ob)(Nb(b.tickInterval, d.units), b.min, b.max, d.startOfWeek, b.ordinalPositions, b.closestPointRange, !0) : e ? b.getLogTickPositions(b.tickInterval, b.min, b.max) : b.getLinearTickPositions(b.tickInterval, b.min, b.max),
            b.tickPositions = i;
            if (!h) e = i[0],
            f = i[i.length - 1],
        ...
        render: function() {
            ...
            function(b, c) {
                ...
                if (!f || b >= a.min && b <= a.max) j[b] || (j[b] = new Pa(a, b)),
    ...
    qb.prototype = {
        ...
        resetTracker: function(a) {
            ...
            d = b.hoverPoint,
            e = b.tooltip,
            b = e && e.shared ? b.hoverPoints: d; (a = a && e && b) && oa(b)[0].plotX === x && (a = !1);
            if (a) e.refresh(b);
            else {
                if (d) d.onMouseOut();
                if (c) c.onMouseOut();
        ...
        setDOMEvents: function() {
            ...
            d.onmousedown = function(d) {
                d = b.normalizeMouseEvent(d); ! ga && d.preventDefault && d.preventDefault();
                c.mouseIsDown = !0;
                c.cancelClick = !1;
    ...
    sb.prototype = {
        ...
        getMargins: function() {
            ...
            } else if (y === "bottom" && !u(j)) this.marginBottom = v(this.marginBottom, f.legendHeight - t + o + d);
    ...
    Ta.prototype = {
        ...
        onMouseOut: function() {
            var a = this.series.chart,
            b = a.hoverPoints;
            if (!b || Rb(this, b) === -1) this.firePointEvent("mouseOut"),
            this.setState(),
            a.hoverPoint = null
        },
    ...
    R.prototype = {
        ...
        generatePoints: function() {
            ...
            b = this.data = b;
            for (m = 0; m < g; m++) i = h + m,
            j ? l[m] = (new f).init(this, [d[m]].concat(oa(e[m]))) : (b[i] ? k = b[i] : a[i] !== x && (b[i] = k = (new f).init(this, a[i], d[m])), l[m] = k);
        ...
        translate: function() {
            ...
            for (l = 0; l < h; l++) {
                ...
                if (c && this.visible && q && q[o]) s = q[o],
                o = s.total,
                s.cum = s = s.cum - n,
                n = s + n,
                j && (s = p(b.threshold, f.isLog ? null: f.min)),
                c === "percent" && (s = o ? s * 100 / o: 0, n = o ? n * 100 / o: 0),
        ...
        drawDataLabels: function() {
            ...
            if (c.enabled || a._hasPointLabels) {
                ...
                function(f) {
                    ...
                    c = h; (g = f.options) && g.dataLabels && (c = C(c, g.dataLabels));
                    if (v = c.enabled) n = f.barX && f.barX + f.barW / 2 || p(f.plotX, -999),
                    q = p(f.plotY, -999),
                    y = c.y === null ? f.y >= b.threshold ? -A + w: w: c.y,
                    ...
                    if (B && !v) f.dataLabel = B.destroy();
                        ...
                        o === "column" && (d += {
                            left: -1,
                            right: 1
                        } [n] * f.barW / 2 || 0); ! r && m && f.y < 0 && (n = "right", d -= 10);
    ...
    Ca = da(R, {
        ...
        drawPoints: function() {
            ...
            function(f) {
                ...
                e = f.shapeArgs,
                d ? (eb(d), d.animate(C(e))) : f.graphic = d = c[f.shapeType](e).attr(f.pointAttr[f.selected ? "select": ""]).add(a.group).shadow(b.shadow, null, b.stacking && !b.borderRadius)
            })
        },
        drawTracker: function() {
            var a = this,
            ...
            function(h) {
                ...
                function(b) {
                    if (!g.stickyTracking && (k = b.relatedTarget || b.toElement, B(k, "isTracker") !== f)) a.onMouseOut()
                }).css(i).add(h.group || j)
            })
        },
        animate: function(a) {
                ...
                for (a = r[0][0] && r[0][0].dataLabel && (r[0][0].dataLabel.getBBox().height || 21); v--;) {
                    ...
                    if (j > 0) {
                        ...
                        if (C > t) {
                            ...
                            for (w = C; w--;) A[w].rank >= t && A.splice(w, 1);
                            C = A.length
                        }
                        for (w = 0; w < C; w++) {
                            b = A[w];
                    ...
                    for (w = 0; w < C; w++) {
                        ...
                        h = i ? ["M", s + (h[6] === "left" ? 5 : -5), q, "C", s, q, 2 * h[2] - h[4], 2 * h[3] - h[5], h[2], h[3], "L", h[4], h[5]] : ["M", s + (h[6] === "left" ? 5 : -5), q, "L", h[2], h[3], "L", h[4], h[5]],
                        g ? (g.animate({
                            d: h
