            ...
            function Scroller(elem, settings) {
                ...
                function generateWheelItems(i) {
                    ...
                    for (j in warr[i]) {
                        ...
                        // var hi_transform = hi*2/64;
                        html += '<div class="dw-li dw-v" data-val="' + j + '" style="height:' + _hhh/s.rows + 'rem;line-height:' + _hhh/s.rows + 'rem;"><div class="dw-i">' + warr[i][j] + '</div></div>';
                        l++;
                    }
                    html += '</div>';
                    return html;
                ...
                */
                that.scroll = function (t, index, val, time, orig) {
                    ...
                    t.attr('style', (prefix + '-transition:all ' + (time ? time.toFixed(3) : 0) + 's ease-out;') + (has3d ? (prefix + '-transform:translate3d(0,' + _px + 'rem,0);') : ('top:' + _px + 'rem;')));
                ...
                that.show = function (prevAnim) {
                    ...
                    for (i = 0; i < s.wheels.length; i++) {
                        ...
                        for (label in s.wheels[i]) {
                            ...
                            html += '<td><div class="dwwl dwrc dwwl' + l + '">' + (s.mode != 'scroller' ? '<div class="dwwb dwwbp" style="height:' + _hhh/s.rows + 'rem;line-height:' + _hhh/s.rows + 'rem;"><span>+</span></div><div class="dwwb dwwbm" style="height:' + _hhh/s.rows + 'rem;line-height:' + _hhh/s.rows + 'rem;"><span>&ndash;</span></div>' : '') + '<div class="dwl">' + label + '</div><div class="dww" style="height:' + _hhh + 'rem;min-width:' + _www + 'rem;"><div class="dw-ul">';
                            // Create wheel values
                ...
                */
                that.init = function (ss) {
                    ...
                    hi = s.height;
                    _hhh = (s.rows*hi*2/64).toFixed(2);
                    _www = (s.width*2/64).toFixed(2);
                    anim = s.animate;
