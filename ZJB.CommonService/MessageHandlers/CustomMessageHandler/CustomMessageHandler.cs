...
using Senparc.Weixin.MP.Sample.CommonService.MessageHandlers.Rules;
...
namespace Senparc.Weixin.MP.Sample.CommonService.CustomMessageHandler
{
    ...
    public partial class CustomMessageHandler : MessageHandler<CustomMessageContext>
    {
        ...
        public override IResponseMessageBase OnTextRequest(RequestMessageText requestMessage)
        {
            ...
            {
                var keyword = requestMessage.Content.ToLower();
                ...
                switch (keyword)
                {
                    ...
                    default:
                        ...
                        List<IRule> rules = new List<IRule> { new KeyWordRule(), new LouPanRule() };

                        foreach (IRule rule in rules)
                        {
                            responseMessage = rule.GetMessage(requestMessage);
